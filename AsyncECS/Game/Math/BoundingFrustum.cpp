...
void BoundingFrustum::SetFromViewProjection(const mat4x4& viewProjection) {
	...
	// Near plane
	planes[4].normal.x = viewProjection[3][0] + viewProjection[2][0];
	planes[4].normal.y = viewProjection[3][1] + viewProjection[2][1];
	planes[4].normal.z = viewProjection[3][2] + viewProjection[2][2];
